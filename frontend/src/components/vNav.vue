  ...
  <div>
    <div class="nav-content">
      ...
      <div class="newsContent">
        ...
        <div class="section" v-for="item in newData" @click="toDetail(item, index)">
          <div class="news">
            <div class="news-left">
              <img :src="item.pic || require('../assets/add.png')" alt="">
            </div>
...
//    this.$store.commit('loading', true)
  ...
  computed: {
    ...
    newData() {
      console.log("chanelData", this.$store.state.channelData)
